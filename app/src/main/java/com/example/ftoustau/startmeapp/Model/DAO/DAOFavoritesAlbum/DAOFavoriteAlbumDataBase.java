package com.example.ftoustau.startmeapp.Model.DAO.DAOFavoritesAlbum;
...
/**
 * Created by ftoustau on 04/07/17.
 */

public class DAOFavoriteAlbumDataBase extends DatabaseHelper {
    public static final String TABLE_NAME = "FavoritesAlbums";
    ...
    public DAOFavoriteAlbumDataBase(Context context) {
        super(context);
    }
